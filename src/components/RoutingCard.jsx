...
const RoutingCard = ({
  ...
  return (
    <div className="w-full max-w-[500px] bg-card-bg border border-border-app rounded-xl p-4 shadow-sm select-none text-left transition-all duration-200 hover:border-neutral-400 dark:hover:border-neutral-700 hover:shadow-lg group/card">
      ...
      {/* Reason Description */}
      <div className="text-xs text-secondary leading-relaxed mb-4 select-text">
        {reasonVal}
      </div>
      ...
      <div className="grid grid-cols-3 gap-2.5 mb-4">
        ...
        <div className="bg-sidebar-bg border border-border-app rounded-lg p-2 flex flex-col justify-center text-center">
          <span className="text-[9px] text-secondary font-mono uppercase tracking-wider mb-0.5">Expected Cost</span>
          <span className="text-[11px] font-semibold text-primary font-mono">{costVal}</span>
        </div>

        {/* Savings Badge */}
        <div className="bg-sidebar-bg border border-border-app rounded-lg p-2 flex flex-col justify-center text-center">
          <span className="text-[9px] text-secondary font-mono uppercase tracking-wider mb-0.5">Est. Savings</span>
        ...
        {/* Speed Badge */}
        <div className="bg-sidebar-bg border border-border-app rounded-lg p-2 flex flex-col justify-center text-center">
          <span className="text-[9px] text-secondary font-mono uppercase tracking-wider mb-0.5">Response Speed</span>
