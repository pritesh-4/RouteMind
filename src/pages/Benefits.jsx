...
// Simple fade-in animation values to follow clean Vercel-like aesthetics
const fadeInUp = {
...
const Benefits = () => {
  return (
    <div className="min-h-screen bg-app-bg text-[#FAFAFA] flex flex-col font-sans selection:bg-blue-600/30 selection:text-white relative overflow-x-hidden">
      ...
      {/* Radial Background Accent to mirror index background details */}
      ...
      <main className="max-w-[1100px] w-full mx-auto px-6 py-16 md:py-24 flex-1 flex flex-col gap-28 md:gap-36">
        ...
        >
          <motion.div 
            variants={fadeInUp}
            className="inline-flex items-center gap-2 px-3 py-1 rounded-full border border-blue-500/20 bg-blue-950/20 text-[10px] font-semibold text-blue-400 font-mono tracking-wider uppercase select-none"
          >
          ...
          >
            RouteMind removes the complexity of choosing between AI models by automatically selecting the best option for every task.
          </motion.p>
          ...
          >
            Modern AI users spend unnecessary time deciding which model to use. RouteMind eliminates that decision-making process while remaining transparent about every routing decision.
          </motion.p>
        </motion.section>
        ...
        <section className="space-y-20 md:space-y-28">
          ...
          {/* Benefit 1: Smarter Model Selection */}
          <div className="grid grid-cols-1 md:grid-cols-2 gap-10 items-center">
            ...
            {/* Visual Widget for Selection */}
            <div className="bg-card-bg border border-border-app rounded-xl p-5 font-mono text-xs text-left shadow-lg relative group/widget">
              <div className="absolute inset-0 bg-blue-500/2 blur-lg pointer-events-none rounded-xl"></div>
              ...
              <div className="space-y-3">
                <div className="p-3 bg-sidebar-bg border border-border-app rounded-lg">
                ...
                <div className="flex justify-center py-1">
                  <ArrowRight size={14} className="text-neutral-600 rotate-90 md:rotate-0 animate-pulse" />
                </div>

                <div className="p-3 bg-sidebar-bg/60 border border-blue-500/20 rounded-lg">
          ...
          {/* Benefit 2: Reduced Decision Fatigue */}
          <div className="grid grid-cols-1 md:grid-cols-2 gap-10 items-center">
            {/* Visual Widget for fatigue reduction */}
            <div className="order-last md:order-first bg-card-bg border border-border-app rounded-xl p-5 font-mono text-xs text-left shadow-lg">
              <div className="grid grid-cols-2 gap-4">
                {/* Before manual loop */}
                <div className="p-3.5 bg-sidebar-bg border border-border-app rounded-lg flex flex-col justify-between min-h-[160px]">
                  <div>
                    ...
                    <div className="space-y-1.5 text-[10px] text-neutral-400">
                      <div className="flex items-center gap-1.5">
                        ...
                        <span>Open ChatGPT tab</span>
                      </div>
                      <div className="flex items-center gap-1.5">
                        <span className="h-1.5 w-1.5 rounded-full bg-red-400/40 shrink-0"></span>
                        <span>Open Claude tab</span>
                      </div>
                      <div className="flex items-center gap-1.5">
                        <span className="h-1.5 w-1.5 rounded-full bg-red-400/40 shrink-0"></span>
                        <span>Open Gemini tab</span>
                      </div>
                      <div className="flex items-center gap-1.5">
                        <span className="h-1.5 w-1.5 rounded-full bg-red-400/40 shrink-0"></span>
                ...
                {/* After RouteMind */}
                <div className="p-3.5 bg-sidebar-bg/60 border border-green-500/20 rounded-lg flex flex-col justify-between min-h-[160px]">
                  <div>
          ...
          {/* Benefit 3: Transparent AI Decisions */}
          <div className="grid grid-cols-1 md:grid-cols-2 gap-10 items-center">
            <div className="space-y-4">
              <div className="inline-flex p-2 rounded-lg bg-blue-950/30 border border-blue-500/20 text-blue-400">
                <Eye size={18} />
            ...
            {/* Visual Widget for Explainability */}
            <div className="bg-card-bg border border-border-app rounded-xl p-5 font-mono text-xs text-left shadow-lg">
              <div className="flex items-center justify-between border-b border-border-app/40 pb-2.5 mb-3">
                <span className="text-[9px] text-neutral-500 font-semibold uppercase">Explainability Metadata</span>
              ...
              <div className="space-y-2.5">
                ...
                <div className="py-1">
                  ...
                  <span className="text-neutral-300 leading-normal block bg-sidebar-bg/60 p-2 rounded border border-border-app/40">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-10 items-center">
            {/* Visual Widget for Cost */}
            <div className="order-last md:order-first bg-card-bg border border-border-app rounded-xl p-5 font-mono text-xs text-left shadow-lg">
              <div className="space-y-4">
                <div className="flex items-center justify-between border-b border-border-app/40 pb-2.5">
                  <span className="text-[9px] text-neutral-500 font-semibold uppercase">Token Budget Comparison</span>
                ...
                <div className="p-2.5 bg-blue-950/20 border border-blue-500/10 rounded-lg text-blue-400 text-[10px] leading-normal">
                  Savings Check: 98% reduced cost with comparable accuracy for simple text summaries.
                </div>
              </div>
            </div>
          ...
          {/* Benefit 5: Unified AI Experience */}
          <div className="grid grid-cols-1 md:grid-cols-2 gap-10 items-center">
            <div className="space-y-4">
              <div className="inline-flex p-2 rounded-lg bg-blue-950/30 border border-blue-500/20 text-blue-400">
                <Workflow size={18} />
            ...
            <div className="bg-card-bg border border-border-app rounded-xl p-5 font-mono text-xs text-left shadow-lg">
              <div className="space-y-2">
                ...
                <div className="flex justify-between items-center bg-sidebar-bg/60 p-2.5 border border-border-app/40 rounded-lg">
                  <span className="text-neutral-400">OpenAI Endpoint</span>
                  <span className="text-[10px] px-1.5 py-0.5 rounded bg-blue-950/40 border border-blue-500/20 text-blue-400 font-semibold font-mono">CONNECTED</span>
                </div>

                <div className="flex justify-between items-center bg-sidebar-bg/60 p-2.5 border border-border-app/40 rounded-lg">
                  <span className="text-neutral-400">Anthropic Endpoint</span>
                  <span className="text-[10px] px-1.5 py-0.5 rounded bg-blue-950/40 border border-blue-500/20 text-blue-400 font-semibold font-mono">CONNECTED</span>
                </div>
        ...
        <section className="space-y-8">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
            ...
            {/* Developer */}
            <div className="bg-card-bg border border-border-app rounded-xl p-5 space-y-4 flex flex-col justify-between hover:border-border-app/80 transition-all duration-200 shadow-sm">
              <div className="space-y-3">
                <div className="flex items-center gap-2">
                  <div className="w-8 h-8 rounded-lg bg-blue-950/20 border border-blue-500/20 text-blue-400 flex items-center justify-center font-mono text-xs font-bold">
                    DEV
                  </div>
                  <div>
                    <h3 className="text-xs font-semibold text-white">Developer</h3>
                    <p className="text-[9px] text-neutral-500">Refactoring & Review</p>
                  </div>
                </div>
                <div className="space-y-1.5 font-mono text-[10px]">
                  <div>
                    <span className="text-neutral-500">Task:</span>
                    <p className="text-white mt-0.5">Review React Architecture</p>
                  </div>
                  <div>
                    <span className="text-neutral-500">Selected Model:</span>
              ...
              <p className="text-[10px] text-neutral-400 leading-relaxed border-t border-border-app/30 pt-3">
                Selected due to strong code understanding and debugging algorithms.
              </p>
            </div>
            ...
            <div className="bg-card-bg border border-border-app rounded-xl p-5 space-y-4 flex flex-col justify-between hover:border-border-app/80 transition-all duration-200 shadow-sm">
              <div className="space-y-3">
                <div className="flex items-center gap-2">
                  <div className="w-8 h-8 rounded-lg bg-green-950/20 border border-green-500/20 text-green-400 flex items-center justify-center font-mono text-xs font-bold">
                    RES
                  </div>
                  <div>
                    <h3 className="text-xs font-semibold text-white">Researcher</h3>
                    <p className="text-[9px] text-neutral-500">Document Parsing</p>
                  </div>
                </div>
                <div className="space-y-1.5 font-mono text-[10px]">
                  <div>
                    <span className="text-neutral-500">Task:</span>
                    <p className="text-white mt-0.5">Analyze 50-page PDF report</p>
                  </div>
                  <div>
                    <span className="text-neutral-500">Selected Model:</span>
                    <p className="text-blue-400 font-semibold mt-0.5 flex items-center gap-1">
                      <Cpu size={10} /> Gemini Pro
                    </p>
                  </div>
                </div>
              </div>
            ...
            <div className="bg-card-bg border border-border-app rounded-xl p-5 space-y-4 flex flex-col justify-between hover:border-border-app/80 transition-all duration-200 shadow-sm">
              <div className="space-y-3">
                <div className="flex items-center gap-2">
                  <div className="w-8 h-8 rounded-lg bg-purple-950/20 border border-purple-500/20 text-purple-400 flex items-center justify-center font-mono text-xs font-bold">
                    STU
                  </div>
                  <div>
                    <h3 className="text-xs font-semibold text-white">Student</h3>
                    <p className="text-[9px] text-neutral-500">Concept Explanation</p>
                  </div>
                </div>
                <div className="space-y-1.5 font-mono text-[10px]">
                  <div>
                    <span className="text-neutral-500">Task:</span>
                    <p className="text-white mt-0.5">Explain Quantum Physics</p>
                  </div>
                  <div>
                    <span className="text-neutral-500">Selected Model:</span>
                    <p className="text-blue-400 font-semibold mt-0.5 flex items-center gap-1">
            ...
            <div className="bg-card-bg border border-border-app rounded-xl p-5 space-y-4 flex flex-col justify-between hover:border-border-app/80 transition-all duration-200 shadow-sm">
              <div className="space-y-3">
                <div className="flex items-center gap-2">
                  <div className="w-8 h-8 rounded-lg bg-yellow-950/20 border border-yellow-500/20 text-yellow-400 flex items-center justify-center font-mono text-xs font-bold">
                    FND
                  </div>
                  <div>
                    <h3 className="text-xs font-semibold text-white">Founder</h3>
                    <p className="text-[9px] text-neutral-500">Creative Copywriting</p>
                  </div>
                </div>
                <div className="space-y-1.5 font-mono text-[10px]">
                  <div>
                    <span className="text-neutral-500">Task:</span>
                    <p className="text-white mt-0.5">Draft pitch email templates</p>
                  </div>
                  <div>
                    <span className="text-neutral-500">Selected Model:</span>
                    <p className="text-blue-400 font-semibold mt-0.5 flex items-center gap-1">
                      <Cpu size={10} /> Claude Sonnet
                    </p>
                  </div>
                </div>
              </div>
              <p className="text-[10px] text-neutral-400 leading-relaxed border-t border-border-app/30 pt-3">
                Selected for highly polished prose style and narrative structure flow.
              </p>
            </div>
        ...
        <section className="space-y-8">
          ...
          <div className="w-full overflow-x-auto rounded-xl border border-border-app bg-[#0E0E0E]">
            <table className="w-full border-collapse text-left text-sm font-sans">
              <thead className="bg-card-bg border-b border-border-app text-xs font-semibold text-white uppercase select-none">
                <tr>
              ...
              <tbody className="divide-y divide-[#262626]/40">
                <tr className="hover:bg-card-bg/20 transition-colors">
                  <td className="px-6 py-4 text-neutral-300 font-medium">Interface Model</td>
                  <td className="px-6 py-4 text-neutral-500">Multiple tabs & developer keys</td>
                  <td className="px-6 py-4 text-white font-medium flex items-center gap-2">
                    <span className="h-1.5 w-1.5 rounded-full bg-blue-400 shrink-0" />
                    <span>One unified console</span>
                  </td>
                </tr>
                <tr className="hover:bg-card-bg/20 transition-colors">
                  <td className="px-6 py-4 text-neutral-300 font-medium">Model Selection</td>
                  <td className="px-6 py-4 text-neutral-500">Manual evaluation</td>
                  <td className="px-6 py-4 text-white font-medium flex items-center gap-2">
                    <span className="h-1.5 w-1.5 rounded-full bg-blue-400 shrink-0" />
                    <span>Automatic proxy routing</span>
                  </td>
                </tr>
                <tr className="hover:bg-card-bg/20 transition-colors">
                  <td className="px-6 py-4 text-neutral-300 font-medium">Experience Focus</td>
                  <td className="px-6 py-4 text-neutral-500">Fragmented context switching</td>
                  <td className="px-6 py-4 text-white font-medium flex items-center gap-2">
                    <span className="h-1.5 w-1.5 rounded-full bg-blue-400 shrink-0" />
                    <span>Unified conversation stream</span>
                  </td>
                </tr>
                <tr className="hover:bg-card-bg/20 transition-colors">
                  <td className="px-6 py-4 text-neutral-300 font-medium">Orchestration Visibility</td>
                  <td className="px-6 py-4 text-neutral-500">Hidden decisions & scores</td>
                  <td className="px-6 py-4 text-white font-medium flex items-center gap-2">
                    <span className="h-1.5 w-1.5 rounded-full bg-blue-400 shrink-0" />
                    <span>Explainable routing decisions</span>
                  </td>
                </tr>
              </tbody>
            </table>
        ...
        <motion.section 
          ...
          variants={staggerContainer}
          className="text-center max-w-2xl mx-auto space-y-8 py-12 select-none border border-border-app/40 bg-card-bg/30 rounded-2xl p-8 relative"
        >
          ...
          <div className="space-y-4">
            ...
            >
              The future of AI is not about using a single model. It is about intelligently orchestrating multiple models and delivering the best outcome for every task.
            </motion.p>
          </div>
